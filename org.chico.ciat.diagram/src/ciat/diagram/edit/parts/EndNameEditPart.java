...
public class EndNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.End_3034, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.EndNameEditPart.VISUAL_ID));
		}
		return parser;
	}
