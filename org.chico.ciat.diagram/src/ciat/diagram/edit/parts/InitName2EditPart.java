...
import ciat.diagram.edit.policies.CiatTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InitName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InitName2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CiatTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CiatElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Init_3038, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.InitName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CiatEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
