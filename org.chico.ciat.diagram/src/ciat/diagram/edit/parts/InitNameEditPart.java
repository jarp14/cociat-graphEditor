 ...
 * @generated
 */
public class InitNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InitNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CiatParserProvider.getParser(CiatElementTypes.Init_3033, getParserElement(),
					CiatVisualIDRegistry.getType(ciat.diagram.edit.parts.InitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
